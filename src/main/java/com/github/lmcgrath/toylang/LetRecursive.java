...
public class LetRecursive implements Expression {
    ...
    public LetRecursive(String name, Expression definition, Expression scope) {
        this.name = name;
    ...
    public <R, S> R accept(ExpressionVisitor<R, S> visitor, S state) throws TypeException {
        return visitor.visitLetRecursive(this, state);
    }
    ...
    public String toString() {
        return "(letrec " + name + " = " + definition + " in " + scope + ")";
    }
}
